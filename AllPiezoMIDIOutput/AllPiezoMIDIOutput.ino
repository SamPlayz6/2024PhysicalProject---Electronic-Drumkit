...
// Sensor analog pins
int sensors[8] = {A2, A3, A4, A5, A8, A9, A10, A11};  // D8, D9, D10, D12 - List of analog pins for the sensors - High Hat1, High Hat2, Right Snare1, Right Snare2
int THRESHOLD = 250;

uint8_t channel = 9;  // MIDI channel 10 for drums (internally 9, correcting the initial channel error)
uint8_t pitches[8] = {38, 42, 46, 47, 48, 49, 50, 51};   // Different pitches for different drum sounds
